...
N3SyntaxError: Top level statements must not be indented
  at line 42 in app.n3

N3SyntaxError: Expected ':' after if condition
  at line 15 in page.n3
```
...
```bash
n3 format app.n3  # Fix indentation, normalize spacing
```
