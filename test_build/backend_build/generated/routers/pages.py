...
@router.get('/api/pages/about', response_model=Dict[str, Any], tags=['pages'])
async def page_about_1_view(session: AsyncSession = Depends(get_session)) -> Dict[str, Any]:
    payload = await runtime.page_about_1(session)
    return payload
