...
page "Products" at "/products" {
    show text: "Product listing"
        ...
        "file:///test/data.ai": '''frame "products" {
    source_type: "csv"
    source: "products.csv"
}
...
frame "users" {
    ...
    doc_symbols = engine.get_document_symbols("file:///test/main.ai")
    print(f"\\nDocument symbols in main.ai: {len(doc_symbols)}")
