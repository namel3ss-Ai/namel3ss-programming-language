...
def demo_symbol_navigation():
    ...
    workspace_files = {
        "file:///project/app.ai": '''app "ECommerce" {
...
memory "user_preferences" {
    ...
    max_items: 100
        ...
        "file:///project/data.ai": '''frame "products" {
...
dataset "sales_data" {
    ...
    schema: [
        ...
        "file:///project/pages.ai": '''page "ProductCatalog" at "/products" {
...
page "Analytics" at "/admin/analytics" {
    ...
    show chart: {
        ...
        "file:///project/prompts.ai": '''prompt "product_recommendation" {
    model: product_llm
    template: """
...
prompt "category_insights" {
    ...
    # Test definition lookup for "products" referenced in pages.ai
    test_position = Position(line=15, character=20)  # Should be on "products" in show table
    definitions = engine.go_to_definition("file:///project/pages.ai", test_position)
    
    print("Looking up definition of 'products' from pages.ai:")
    ...
    test_position_llm = Position(line=5, character=10)  # On "product_llm" in app.ai
    references = engine.find_references("file:///project/app.ai", test_position_llm)
    ...
    hover_info = engine.get_hover_info("file:///project/data.ai", hover_position)
    ...
    # Get symbols in the pages.ai file
    doc_symbols = engine.get_document_symbols("file:///project/pages.ai")
    
    print("Symbols in pages.ai:")
