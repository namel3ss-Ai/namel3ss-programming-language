...
description: "App should come first"
    ...
    workspace_files = {
        "file:///test/legacy.ai": legacy_content,
        "file:///test/modern.ai": modern_content,
        "file:///test/messy.ai": messy_content
    }
    ...
    organize_result = engine.organize_file_structure(messy_content, "file:///test/messy.ai")
