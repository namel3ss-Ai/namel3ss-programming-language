...
async def execute_dataset_pipeline(
    ...
    *,
    ...
    for operation in operations:
        ...
        if otype == "filter":
            current_rows = apply_filter(current_rows, operation.get("condition"), context, dataset_name)
        elif otype == "computed_column":
            apply_computed_column(current_rows, operation.get("name"), operation.get("expression"), context, dataset_name)
        elif otype == "group_by":
