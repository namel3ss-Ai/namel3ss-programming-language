...
def _placeholder_table_rows(columns: List[str]) -> List[Dict[str, Any]]:
...
def _build_placeholder_chart_payload(chart_stmt: ShowChart) -> Dict[str, Any]:
    ...
    for stmt in statements:
        ...
        if isinstance(stmt, ShowText):
            ...
            table_data = {
                "title": stmt.title,
                "columns": columns,
                "rows": _placeholder_table_rows(columns),
            ...
            dataset_payload = _build_placeholder_chart_payload(stmt)
