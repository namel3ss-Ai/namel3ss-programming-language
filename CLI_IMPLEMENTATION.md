...
**Behavior:**
- Automatically converted to: `namel3ss build app.n3 --out dist`
...
- Checks for `.n3` extension or file existence
...
```bash
namel3ss run app.n3 --port 3000 --host 0.0.0.0 --backend-out ./dev_backend
```
...
- Watch `.n3` file for changes and regenerate backend
