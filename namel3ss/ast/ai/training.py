...
- TrainingJob: Full model training specifications
- TuningJob: Hyperparameter optimization jobs
- TrainingComputeSpec: Resource allocation specifications
- HyperparamSpec: Search space specifications for tuning
- EarlyStoppingSpec: Training convergence criteria

This module provides production-grade training job definitions with validation.
Use validate_training_job() and validate_tuning_job() from .validation to ensure
configurations are valid before submitting jobs to training backends.
"""
