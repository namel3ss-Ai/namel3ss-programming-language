...
- StepEvaluationConfig: Evaluation and guardrail configuration
- WorkflowIfBlock: Conditional branching (if/elif/else)
- WorkflowForBlock: Iteration over collections  
- WorkflowWhileBlock: Conditional iteration with safety limits
- Chain: Complete workflow definitions
- WorkflowNode: Union type for all workflow nodes

This module provides production-grade workflow definitions with validation.
Use validate_chain() and validate_chain_step() from .validation to ensure
workflows are well-formed before execution.
"""
