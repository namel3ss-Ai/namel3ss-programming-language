...
- LLMDefinition: Reusable LLM configurations with generation parameters
- ToolDefinition: External tools/APIs that LLMs can invoke via function calling

This module provides production-grade tool definitions with validation.
Use validate_llm_definition() and validate_tool_definition() from .validation
to ensure configurations are valid before runtime.
"""
