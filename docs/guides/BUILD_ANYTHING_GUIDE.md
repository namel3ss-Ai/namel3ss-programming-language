...
# Load .ai file
runtime = N3InProcessRuntime("./workflows.ai")
...
@pytest.fixture
def runtime():
    return N3InProcessRuntime("./test_app.ai")
...
2. Create simple .ai file with one chain
...
runtime = N3InProcessRuntime("./poc.ai")
