...
**Severity**: **HIGH** - Blocks parsing of demo_app.ai
...
**Impact**: Cannot parse demo_app.ai (flagship example)
...
**Affected Files**:
- examples/rag_demo.ai
- examples/advanced_providers.ai
- examples/memory_chat_demo.ai
- examples/multimodal_rag.ai
...
**Severity**: **MEDIUM** - Blocks parsing of safety_policies.ai
...
**Impact**: Cannot parse examples/safety_policies.ai
...
**Affected Files**:
- examples/simple_functional.ai
- examples/provider_demo.ai
- examples/symbolic_demo.ai
- examples/template_examples.ai
- examples/advanced_providers.ai
...
- ✅ Linting job (ruff)
- ✅ Integration test job (demo_app.ai)
...
4. **Fix _error() hint Parameter TypeError**
   - Location: `namel3ss/parser/ai/prompts.py:59`
   - Impact: Blocks safety_policies.ai
