...
### With Filters
```bash
namel3ss build-index app.ai docs_index \
...
# Resume
namel3ss build-index app.ai docs_index --resume --verbose
```

### Force Rebuild
```bash
namel3ss build-index app.ai docs_index --force-rebuild --verbose
```
