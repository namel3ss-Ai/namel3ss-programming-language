...
**What this verifies:**
- **Parser**: `.ai` file parsing (grammar, AST generation, error handling)
...
namel3ss generate-backend examples/provider_demo.ai ./test_backend_output
...
namel3ss generate-frontend examples/provider_demo.ai ./test_frontend_output
...
namel3ss typecheck examples/provider_demo.ai
```
...
namel3ss lint examples/provider_demo.ai
```
...
namel3ss typecheck examples/provider_demo.ai
namel3ss generate-backend examples/provider_demo.ai ./test_output
```
