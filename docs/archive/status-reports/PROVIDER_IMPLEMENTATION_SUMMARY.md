...
- `examples/provider_demo.ai` (120 lines) - Basic DSL examples
- `examples/advanced_providers.ai` (350 lines) - Advanced patterns:
...
### Examples
- ✅ Basic provider usage (provider_demo.ai)
- ✅ Advanced multi-provider workflows (advanced_providers.ai)
