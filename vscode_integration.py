        ...
        return {
            ...
            "repository": {
                "comments": {
                    "patterns": [
                        {
                            "name": "comment.line.double-slash.n3",
                            "match": "//.*$"
                        },
                        {
                            "name": "comment.block.n3",
                            "begin": "/\\*",
                            "end": "\\*/"
                        }
                    ]
                ...
                "identifiers": {
                    "patterns": [
                        {
                            "name": "entity.name.function.n3",
                            "match": "\\b[a-zA-Z_][a-zA-Z0-9_]*\\b(?=\\s*\\()"
                        },
                        {
                            "name": "variable.other.n3",
...
def demo_vscode_integration():
    ...
    instructions = [
        ...
        "6. Open .n3 files to activate language support"
    ]
