...
export class ChatProvider implements vscode.WebviewViewProvider {
    public static readonly viewType = 'namel3ssChat';
    ...
    private async handleUserMessage(message: string) {
        ...
        try {
            ...
            const messagesWithContext: AIMessage[] = [
                {
                    role: 'system',
            ...
            await this.aiProvider.streamChatResponse(messagesWithContext, (chunk: string) => {
                fullResponse += chunk;
...
Total lines: ${document.lineCount}`;
    ...
    private addMessageToChat(role: 'user' | 'assistant', content: string): string {
