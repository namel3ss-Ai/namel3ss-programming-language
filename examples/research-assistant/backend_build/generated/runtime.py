...
APP: Dict[str, Any] = {'name': 'Research Assistant', 'database': None, 'theme': {}, 'variables': []}
DATASETS: Dict[str, Dict[str, Any]] = {}
FRAMES: Dict[str, Dict[str, Any]] = {}
CONNECTORS: Dict[str, Dict[str, Any]] = {}
AI_CONNECTORS: Dict[str, Dict[str, Any]] = {}
AI_MODELS: Dict[str, Dict[str, Any]] = {}
LLM_REGISTRY: Dict[str, Dict[str, Any]] = {'research_llm': {'name': 'research_llm',
                  'provider': 'openai',
                  'model': 'gpt-4o-mini',
                  'temperature': 0.4,
                  'max_tokens': 1024,
...
AI_PROMPTS: Dict[str, Dict[str, Any]] = {'research_answer': {'name': 'research_answer',
                     'model': 'research_llm',
                     'template': '\n'
                                 '  User question:\n'
                                 '  {{question}}\n'
...
AGENT_DEFS: Dict[str, Dict[str, Any]] = {'ResearchAgent': {'name': 'ResearchAgent',
                   'llm': 'research_llm',
                   'tools': [],
                   'system_prompt': None,
