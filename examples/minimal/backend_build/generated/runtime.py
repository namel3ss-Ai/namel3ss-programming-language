...
APP: Dict[str, Any] = {'name': 'Basic App', 'database': None, 'theme': {}, 'variables': []}
DATASETS: Dict[str, Dict[str, Any]] = {}
FRAMES: Dict[str, Dict[str, Any]] = {}
CONNECTORS: Dict[str, Dict[str, Any]] = {}
AI_CONNECTORS: Dict[str, Dict[str, Any]] = {}
AI_MODELS: Dict[str, Dict[str, Any]] = {}
LLM_REGISTRY: Dict[str, Dict[str, Any]] = {'test_model': {'name': 'test_model',
                'provider': 'openai',
                'model': 'gpt-4o-mini',
                'temperature': None,
                'max_tokens': None,
...
AI_PROMPTS: Dict[str, Dict[str, Any]] = {'hello': {'name': 'hello',
           'model': 'test_model',
           'template': 'Hello {{name}}!',
           'input': [],
           'output': [],
