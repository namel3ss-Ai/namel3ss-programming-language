...
- ❌ **CLI compilation blocked** - Cannot parse `.n3` files with `output_schema:`
...
4. Test with existing .n3 files for backward compatibility
...
2. **End-to-End Testing**
   - Compile test_structured_app.n3
