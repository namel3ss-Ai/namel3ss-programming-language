...
APP: Dict[str, Any] = {'name': 'CoffeeHub',
 'database': 'COFFEE_DB',
 'theme': {'primary': '"#795548"', 'background': '"#FFF8E1"', 'text': '"#3E2723"'},
 'variables': []}
DATASETS: Dict[str, Dict[str, Any]] = {'monthly_sales': {'name': 'monthly_sales',
                   'source_type': 'table',
                   'source': 'sales',
                   'operations': [{'type': 'filter', 'condition': "region == 'EU'"},
                                  {'type': 'group_by', 'columns': ['month']},
                                  {'type': 'aggregate',
                                   'function': 'sum',
                                   'expression': 'revenue as total_revenue'}],
                   'transforms': [],
                   'schema': [],
                   'features': [],
                   'targets': [],
                   ...
                   'sample_rows': [{'id': 1, 'value': 10},
                                   {'id': 2, 'value': 20},
                                   {'id': 3, 'value': 30}]}}
CONNECTORS: Dict[str, Dict[str, Any]] = {'monthly_sales': {'type': 'table', 'name': None, 'options': {}}}
...
PAGES: List[Dict[str, Any]] = [{'name': 'Home',
  ...
  'components': [{'type': 'text',
                  'payload': {'text': 'Welcome to CoffeeHub!',
                              'styles': {'color': 'var(--primary)',
                                         'size': 'large',
                                         'align': 'center',
                                         'weight': 'bold'}}},
                 {'type': 'chart',
                  'payload': {'heading': 'Revenue Growth',
                              'title': None,
                              'source_type': 'dataset',
 ...
 {'name': 'Feedback',
  ...
  'slug': 'feedback',
  'index': 1,
  'api_path': '/api/pages/feedback',
  'reactive': False,
  'refresh_policy': None,
  'layout': {},
  'components': [{'type': 'form',
                  'payload': {'title': 'Submit Feedback',
 ...
 {'name': 'Admin',
  ...
  'components': [{'type': 'table',
                  'payload': {'title': 'Orders',
                              ...
                              'dynamic_columns': None}},
                 {'type': 'action',
                  'payload': {'name': 'Approve Order',
                              'trigger': 'user clicks "Approve"',
                              'operations': [{'type': 'update',
                                              'table': 'orders',
                                              'set_expression': 'status = "APPROVED"',
                                              'where_expression': None},
                                             {'type': 'toast', 'message': 'Order approved'},
                                             {'type': 'navigate', 'page_name': 'Admin'}]}}]}]
...
async def page_home_0(session: Optional[AsyncSession] = None) -> Dict[str, Any]:
  ...
  'styles': {'color': 'var(--primary)', 'size': 'large', 'align': 'center', 'weight': 'bold'}},
 {'type': 'chart',
...
async def page_feedback_1(session: Optional[AsyncSession] = None) -> Dict[str, Any]:
    context = build_context('feedback')
    scope = ScopeFrame()
    scope.set('context', context)
    instructions = [{'type': 'form',
  ...
  'layout': {'width': None,
             ...
             'breakpoint': None,
             'props': {}},
  'operations': [{'type': 'toast', 'message': 'Thank you for your feedback!'}],
  'styles': {}}]
    components = await render_statements(instructions, context, scope, session)
    return {
        'name': 'Feedback',
...
async def page_admin_2(session: Optional[AsyncSession] = None) -> Dict[str, Any]:
