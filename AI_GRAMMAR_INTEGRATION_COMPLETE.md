...
Successfully integrated AIParserMixin into the main grammar parser (`namel3ss/lang/grammar.py`) so that structured prompts, AI models, training jobs, tuning jobs, chains, connectors, memory, and templates are all recognized during normal compilation of `.n3` files.
...
5. ⏳ Test CLI with actual .n3 files using AI constructs
6. ⏳ Update documentation with new AI syntax

## Impact

**For Users:**
- Can now use full AI DSL syntax in .n3 files compiled by CLI
