...
- Language Tests - Full .n3 compilation pipeline
...
- Real Example Tests (demo_app.n3, all examples/)
...
**Lines**: 600+  
**Tests**: 33+  
**Coverage**: Full .n3 compilation pipeline
...
- All .n3 files validated by integration tests
...
- All .n3 examples auto-validated
